...
<html>
  ...
  <body>
    ...
    <div id="subselect">
    	<a href="deleteitem.php?subject=1">科目一</a>
    	<a href="deleteitem.php?subject=4">科目四</a>
    </div>
    ...
    <div id="container">
		...
		<div class="item">
			<span>题目编号: </span><span><?php echo $res['id']?></span>
	 		...
	 		<button class="btn" type="button" onclick="deleteItem(this,<?php echo $subject?>,<?php echo $res['id']?>)">删除该题目</button>
		</div>
		<?php } $result=null;?>
